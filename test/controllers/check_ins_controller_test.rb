...
class CheckInsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check_in" do
    assert_difference('CheckIn.count') do
      post check_ins_url, params: { check_in: { mile_run: @check_in.mile_run, push_ups: @check_in.push_ups, sit_ups: @check_in.sit_ups, weight: @check_in.weight } }
    end
  ...
  test "should update check_in" do
    patch check_in_url(@check_in), params: { check_in: { mile_run: @check_in.mile_run, push_ups: @check_in.push_ups, sit_ups: @check_in.sit_ups, weight: @check_in.weight } }
